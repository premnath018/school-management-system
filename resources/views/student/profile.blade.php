                            ...
                            <div class="info-table table-responsive">
                                <table class="table text-nowrap">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Class:</td>
                                            <td class="font-medium text-dark-medium">{{$data->class_name ? $data->class_name  : 'Not added to class'}}</td>
                                        </tr>
                                        <tr>
                                            <td>Fees:</td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="student-submit">
                                    ...
                                    <button type="button" class="btn btn-primary border-0 bg-danger text-white" data-bs-toggle="modal" data-bs-target="#info-alert-modal">Delete Student</button>
                                </div>
                            </div>
                        </div>
                    </form>
