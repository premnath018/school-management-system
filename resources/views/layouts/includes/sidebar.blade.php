			...
			<ul>
				...
				<li class="submenu">
					...
					<ul>
						...
						<li><a href="/earlycallentry">Early Calling Entry</a></li>
						<!-- <li><a href="teacher-details.html">Teacher View</a></li> -->
						<!-- <li><a href="edit-teacher.html">Teacher Edit</a></li> -->
					</ul>
				</li>
				<li class="submenu">
					<a href="#"><i class="fas fa-chalkboard"></i> <span> Class</span> <span class="menu-arrow"></span></a>
					<ul>
				...
				<li class="submenu">
					<a href="#"><i class="fas fa-pen"></i> <span> Exams</span> <span class="menu-arrow"></span></a>
					<ul>
