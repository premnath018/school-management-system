<div class="sidebar" id="sidebar">
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 726px;">
        <div class="sidebar-inner slimscroll" style="overflow: hidden; width: 100%; height: 726px;">
        ...
        <div class="slimScrollBar" style="background: rgb(204, 204, 204); width: 7px; position: absolute; top: 5px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 198.897px;"></div>
